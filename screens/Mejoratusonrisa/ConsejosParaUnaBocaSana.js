    ...
    return (
      <View style={[styles.container,{backgroundColor:'#fbfbfb'}]}>
        ...
        <View style={[styles.carouselcontainer,{height:HEIGHT-150}]}>
          ...
          <View style={[styles.carousel,{top:80,height:HEIGHT-200, flexDirection:'column'}]}>
            ...
            <View style={[styles.panel_right,{top:-25,width:(WIDTH-50),height:HEIGHT-200,flexDirection:'row',justifyContent:'center',alignItems:'center'}]}>
