        ...
        <View style={[styles.carouselcontainer,{height:HEIGHT-150}]}>
          ...
          <View style={[styles.carousel,{top:80,height:HEIGHT-230}]}>
            ...
            <View style={[styles.panel_one,{width:(WIDTH/2)-150,height:HEIGHT-230,alignItems:'center'}]}>
              <Text style={[styles.globalText,{position:'relative',top:40,left:90,marginTop:50,fontSize:22,width:400, marginBottom:25}]}>Cambia tu cepillo cuando sus ﬁlamentos estén deformados,de esta manera lograras unmejor control de la placabacteriana y al mismo tiempo evitaras la contaminación de tu cepillo por uso prolongado en el tiempo..</Text>
            </View>
            <View style={[styles.panel_third,{width:(WIDTH/2)+100,height:HEIGHT-230, alignItems:'center'}]}>
              <Text style={[styles.globalText,{position:'relative',top:40,left:120,marginTop:50,fontSize:22,width:400, marginBottom:25}]}>Estudios han demostrado que después de 3 meses de uso regular, un cepillo es menos efectivo para remover la placa de los dientes y de las encías, en comparación con un cepillo nuevo.</Text>
            </View>
          </View>
        </View>
