        ...
        <View style={[styles.carouselcontainer,{height:HEIGHT-150}]}>
          ...
          <View style={[styles.carousel,{top:40,width:WIDTH,height:HEIGHT-310}]}>
            <View style={[styles.panel_one,{width:(WIDTH/2),height:HEIGHT-310,alignItems:'center', alignItems:'center'}]}>
              <View style={{width:(WIDTH/3)-0,padding:10,paddingLeft:10,paddingRight:10,height:153,borderRadius:8}}>
                <Text style={{fontSize:25,marginTop:15,textAlign:'center',fontFamily:'ColgateReady',fontWeight:'600'}}>¿Cada cuanto hay que <Text style={{fontFamily:'ColgateReady',color:'red'}}>cambiar</Text></Text>
                <Text style={{fontSize:25,textAlign:'center',fontFamily:'ColgateReady',fontWeight:'600',color:'red'}}>el cepillo de dientes?</Text>
                <Image source={require('../../images/Preguntas/reactangulo-preguntas.png')} style={{position:'absolute',left:-5,top:0,width:(WIDTH/3)+10,paddingLeft:10,paddingRight:10,padding:10,height:140,borderRadius:8}} />
              </View>
              ...
              {this.state.Answers[0].FirstResponses.map((item,index) => {
                ...
                return(
                  <TouchableOpacity key={index} style={{flexDirection:'row',height:40, left:30,marginBottom:15}} onPress={() => this.chooseAnswer(index,item.valid)}>
                    ...
                    <Text style={[{fontSize:22,top:3,fontFamily:'ColgateReady',fontWeight:'600'},stylevalid]}>{item.answer}</Text>
            ...
            <View style={{width:(WIDTH/3)-0,padding:10,paddingLeft:10,paddingRight:10,height:153,borderRadius:8}}>
              <Text style={{fontSize:25,marginTop:15,textAlign:'center',fontFamily:'ColgateReady',fontWeight:'600'}}>¿Que elementos se necesitan</Text>
              <Text style={{fontSize:25,textAlign:'center',fontFamily:'ColgateReady',fontWeight:'600'}}>Para una <Text style={{color:'red',fontFamily:'ColgateReady-Italic',fontWeight:'600'}}>correcta higiene?</Text></Text>
              <Image source={require('../../images/Preguntas/reactangulo-preguntas.png')} style={{position:'absolute',left:-5,top:0,width:(WIDTH/3)-30,paddingLeft:10,paddingRight:10,padding:10,height:140,borderRadius:8}} />
            </View>
            <View style={{width:(WIDTH/3)-90,height:380,marginTop:25}}>
