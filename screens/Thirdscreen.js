    ...
    return (
      <View style={[styles.container,{backgroundColor:'#fbfbfb'}]}>
        ...
        <View style={styles.panel_top}>
          <TouchableOpacity style={{top:25,left:100,padding:10, height:310}} onPress={() => this.props.navigation.navigate('Fourscreen')}><Image source={require('../images/Producto-ideal.png')} style={{width:290,height:290,transform: [{ scale: 1 }]}} /></TouchableOpacity>
          <TouchableOpacity style={{top:30,right:110,padding:10, height:310}} onPress={() => this.props.navigation.navigate('QuestionFirstScreen')}><Image source={require('../images/cuidado-oral.png')} style={{width:290,height:290,transform: [{ scale: 1 }]}} /></TouchableOpacity>
        </View>
