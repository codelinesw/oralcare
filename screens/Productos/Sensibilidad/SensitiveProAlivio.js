      ...
      <View style={[styles.container,{backgroundColor:'#fbfbfb'}]}>
        ...
        <View style={[styles.carouselcontainer,{height:HEIGHT-150}]}>
          ...
          <View style={[styles.carousel,{top:40,width:WIDTH,height:HEIGHT-310}]}>
            ...
            <Text style={{width:465,fontSize:18,right:40,marginTop:1,marginBottom:5}}>Exclusiva fórmula Pro-Argin.</Text>
            <Text style={{marginTop:3,fontSize:15,right:40,width:385,marginBottom:5}}>Alivio Instantáneo (Con aplicación directa)</Text>
            <Text style={{marginTop:3,fontSize:15,right:40,marginBottom:5}}>Alivio duradero (Con cepillado diario)</Text>
            </View>
          </View>
        </View>
