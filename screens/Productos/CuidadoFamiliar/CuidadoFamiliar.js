...
export default class CuidadoFamiliar extends React.Component {
      ...
      <View style={[styles.container,{backgroundColor:'#fbfbfb'}]}>
        ...
        <View style={[styles.carouselcontainer,{height:HEIGHT-150}]}>
          <View style={[styles.containerTitle,{top:-25}]}>
            <Image source={require('../../../images/Productos/CuidadoFamiliar/Titulo.png')} style={{top:-215,zIndex:-1,width:1750,height:520,transform: [{ scale: 0.22 }]}} />
          </View>
        ...
        <ButtonSlide screenPrev="Fourscreen" screenNext="MenucuidadoFamiliar" navigation={this.props.navigation} showbutton={true}/>
