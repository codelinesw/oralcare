...
export default class MenucuidadoFamiliar extends React.Component {
  ...
  render(){
    return (
      <View style={[styles.container,{backgroundColor:'#fbfbfb'}]}>
          ...
          <View style={[styles.carousel,{top:40,width:WIDTH,height:HEIGHT-10,flexDirection:'column'}]}>
            <View style={[styles.panel_one,{width:(WIDTH-320),height:HEIGHT-440,flexDirection:'row',justifyContent:'space-between',alignItems:'center',}]}>
              <TouchableOpacity
                ...
                >
                <Image
                source={require('../../../images/Productos/CuidadoFamiliar/Menu/01.png')}
                style={{width:240,height:220,transform: [{ scale: 1 }]}}
                />
              </TouchableOpacity>
              <TouchableOpacity
                style={[styles.buttonButtonCarousel_,styles.BoxButton,{width:240,height:220,top:-50}]}
                onPress={() => this.props.navigation.navigate('CepillaTusDientes')}
                >
                <Image
                source={require('../../../images/Productos/CuidadoFamiliar/Menu/06.png')}
                style={{width:240,height:220,transform: [{ scale: 1 }]}}
                />
              </TouchableOpacity>
              <TouchableOpacity
                ...
                >
                <Image
                source={require('../../../images/Productos/CuidadoFamiliar/Menu/05.png')}
                style={{width:240,height:220,transform: [{ scale: 1 }]}}
                />
              </TouchableOpacity>
            </View>
            ...
            <View style={[styles.panel_second,{width:(WIDTH-320),height:HEIGHT-440,flexDirection:'row',justifyContent:'space-between',alignItems:'center'}]}>
                <TouchableOpacity
                  ...
                  >
                  <Image
                  source={require('../../../images/Productos/CuidadoFamiliar/Menu/02.png')}
                  style={{width:240,height:220,transform: [{ scale: 1 }]}}
                  />
                </TouchableOpacity>
                <TouchableOpacity
                  ...
                  >
                  <Image
                  source={require('../../../images/Productos/CuidadoFamiliar/Menu/03.png')}
                  style={{width:240,height:220,transform: [{ scale: 1 }]}}
                  />
                </TouchableOpacity>
                <TouchableOpacity
                  ...
                  >
                  <Image
                  source={require('../../../images/Productos/CuidadoFamiliar/Menu/04.png')}
                  style={{width:240,height:220,transform: [{ scale: 1 }]}}
                  />
                </TouchableOpacity>
            </View>
        ...
        <ButtonSlide screenPrev="CuidadoFamiliar" screenNext="MaximaProteccion" navigation={this.props.navigation}/>
