        ...
        <View style={[styles.carouselcontainer,{height:HEIGHT-150}]}>
          ...
          <View style={[styles.carousel,{top:40,width:WIDTH,height:HEIGHT-310}]}>
            ...
            <View style={[styles.panel_second,{width:(WIDTH/2),height:HEIGHT-310}]}>
                <Text style={[styles.ItalicText,{color:'red',fontSize:22,left:5,marginTop:110,marginBottom:0}]}>BENEFICIOS:</Text>
                <Text style={[styles.globalText,{width:465,fontSize:22,left:5,marginTop:5}]}>Su innovadora tecnología ahora combina abrillantadores ópticos para blanquear los dientes instantáneamente.</Text>
                <Text style={[styles.globalText,{marginTop:70,fontSize:13,left:5,width:485}]}>*Efecto blanqueador instantáneo es temporal.</Text>
            </View>
          </View>
        </View>
