        ...
        <View style={[styles.carouselcontainer,{height:HEIGHT-150}]}>
          ...
          <View style={[styles.carousel,{top:40,width:WIDTH,height:HEIGHT-310}]}>
            ...
            <View style={[styles.panel_second,{width:(WIDTH/2),height:HEIGHT-310}]}>
                <Text style={[{color:'red',fontSize:22,left:45,marginTop:70,marginBottom:8},styles.ItalicText]}>BENEFICIOS:</Text>
                <Text style={[styles.globalText,{width:465,fontSize:18,left:45,marginTop:2}]}>Combate gérmenes por 12 horas.</Text>
                <Text style={[styles.globalText,{width:465,fontSize:18,left:45,marginTop:2}]}>Aliento fresco.</Text>
                <Text style={[styles.globalText,{width:465,fontSize:18,left:45,marginTop:2}]}>Máxima protección anticaries.</Text>
                <Text style={[styles.globalText,{width:465,fontSize:18,left:45,marginTop:2}]}>Fortalece y blanquea tus dientes.</Text>
            </View>
          </View>
        </View>
