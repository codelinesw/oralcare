        ...
        <View style={[styles.carouselcontainer,{height:HEIGHT-150}]}>
          <View style={[styles.carousel,{top:40,width:WIDTH,height:HEIGHT-310}]}>
            <View style={[styles.panel_one,{width:(WIDTH/3),height:HEIGHT-310,alignItems:'center', alignItems:'center'}]}>
                <Image source={require('../../../images/Productos/Cuidadodelosmaschicos/Cepillos2Pack/01.png')} style={{left:65,top:-1965,width:1800,height:4120,transform: [{ scale: 0.110 }],marginBottom:25}} />
            </View>
            <View style={[styles.panel_second,{width:(WIDTH/3),height:HEIGHT-310}]}>
                <Image source={require('../../../images/Productos/Cuidadodelosmaschicos/Cepillos2Pack/02.png')} style={{right:525,top:-1675,width:1500,height:3520,transform: [{ scale: 0.125 }],marginBottom:25}} />
            </View>
            <View style={[styles.panel_third,{width:(WIDTH/3),height:HEIGHT-310,alignItems:'center', alignItems:'center'}]}>
                <Image source={require('../../../images/Productos/Cuidadodelosmaschicos/Cepillos2Pack/03.png')} style={{right:65,top:-1665,width:1500,height:3520,transform: [{ scale: 0.125 }],marginBottom:25}} />
            </View>
          </View>
        </View>
