...
export default class LigadelaJusticia extends React.Component {
      ...
      <View style={[styles.container,{backgroundColor:'#fbfbfb'}]}>
        ...
        <View style={[styles.carouselcontainer,{height:HEIGHT-150}]}>
          <View style={[styles.containerTitle,{top:-25}]}>
            <Image source={require('../../../images/Productos/Cuidadodelosmaschicos/LigadelaJusticia/Titulo.png')} style={{top:-140,left:120,zIndex:-1,width:1750,height:420,transform: [{ scale: 0.25 }]}} />
          </View>
        ...
        <ButtonSlide screenPrev="BarbieMinions" screenNext="Cepilloschicos" navigation={this.props.navigation} showbutton={false}/>
