...
export default class MenuMultiBeneficios extends React.Component {
          ...
          <View style={[styles.carousel,{top:40,width:WIDTH,height:HEIGHT-10,flexDirection:'column'}]}>
            <View style={[styles.panel_one,{width:(WIDTH-320),height:HEIGHT-440,flexDirection:'row',justifyContent:'space-between',alignItems:'center',}]}>
              <TouchableOpacity
                ...
                >
                <Image
                source={require('../../../images/Productos/Multibeneficios/Menu/01.png')}
              ...
              <TouchableOpacity
                ...
                >
                <Image
                source={require('../../../images/Productos/Multibeneficios/Menu/06.png')}
                style={{width:240,height:220,transform: [{ scale: 1 }]}}
                />
              </TouchableOpacity>
              <TouchableOpacity
                ...
                >
                <Image
                source={require('../../../images/Productos/Multibeneficios/Menu/05.png')}
                style={{width:240,height:220,transform: [{ scale: 1 }]}}
                />
              </TouchableOpacity>
            </View>
            ...
            <View style={[styles.panel_second,{width:(WIDTH-320),height:HEIGHT-440,flexDirection:'row',justifyContent:'space-between',alignItems:'center'}]}>
                <TouchableOpacity
                  ...
                  >
                  <Image
                  source={require('../../../images/Productos/Multibeneficios/Menu/02.png')}
                  style={{width:240,height:220,transform: [{ scale: 1 }]}}
                  />
                </TouchableOpacity>
                <TouchableOpacity
                  ...
                  >
                  <Image
                  source={require('../../../images/Productos/Multibeneficios/Menu/03.png')}
                  style={{width:240,height:220,transform: [{ scale: 1 }]}}
                  />
                </TouchableOpacity>
                <TouchableOpacity
                  ...
                  >
                  <Image
                  source={require('../../../images/Productos/Multibeneficios/Menu/04.png')}
                  style={{width:240,height:220,transform: [{ scale: 1 }]}}
                  />
                </TouchableOpacity>
            </View>
