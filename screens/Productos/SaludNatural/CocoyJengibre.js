        ...
        <View style={[styles.carouselcontainer,{height:HEIGHT-150}]}>
          ...
          <View style={[styles.carousel,{top:40,width:WIDTH,height:HEIGHT-310}]}>
            ...
            <View style={[styles.panel_second,{width:(WIDTH/2),height:HEIGHT-310}]}>
                ...
                <Text style={{marginTop:3,fontSize:15,right:80,width:385}}>Contiene extractos naturales de aceite de coco y jengibre que ayudan a eliminar bacterias que causan el mal aliento, la caries y problemas de encías. Ayuda a fortalecer los dientes y proporciona una sensación natural refrescante</Text>
                <Text style={{marginTop:3,fontSize:15,right:80}}>El sabor del jengibre proporciona una sensación refrescante</Text>
                <Text style={{marginTop:3,fontSize:15,right:80}}>El aceite de coco proporciona una sensación suave y dulce</Text>
            </View>
          </View>
        </View>
